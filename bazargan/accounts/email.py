...
class BaseTemplateEmail(BaseEmailMessage):
    def get_context_data(self):
        context = super().get_context_data()
        overridable = {
            "protocol": getattr(settings, "EMAIL_FRONTEND_PROTOCOL", ""),
            "domain": getattr(settings, "EMAIL_FRONTEND_DOMAIN", ""),
            "site_name": getattr(settings, "EMAIL_FRONTEND_SITE_NAME", ""),
        }
